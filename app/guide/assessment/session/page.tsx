...
import { Send, Loader2, Lightbulb, Headphones, Keyboard } from 'lucide-react';
import {
  AssessmentVoiceCoach,
  type AssessmentOnboardingData,
} from '@/components/AssessmentVoiceCoach';
...
function AssessmentSessionPage() {
  ...
  const [onboardingData, setOnboardingData] = useState<AssessmentOnboardingData | null>(null);
  ...
  useEffect(() => {
    ...
    if (data) {
      ...
      setOnboardingData(parsed as AssessmentOnboardingData);
